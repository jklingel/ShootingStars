...
Move tank with H-left and K-right, avoid the shooting stars.
...
+ Zero Page + Content                                        + 
+-----------+------------------------------------------------+
+ $fb       + Current star position, low byte ($0400-$07e8)  +
+-----------+------------------------------------------------+
+ $fc       + Current star position, high byte               +
+-----------+------------------------------------------------+
+ $fd       + Current tank position, low byte ($07c0-$07e8)  +
+-----------+------------------------------------------------+
+ $fe       + Current tank position, high byte               +
+-----------+------------------------------------------------+
